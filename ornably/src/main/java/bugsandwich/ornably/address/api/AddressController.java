...
public class AddressController {
	...
	public ResponseEntity <Map<String, Object>> getMyAddresses(
		...
		System.out.println("[로그] 로그인한 사용자SSS PK :" + ornablyUser.getAccountPk());
		...
		System.out.println("[로그] 가져온 주소 목록 : " + addressService.getAddressList(addressDTO));
	...
	//accountPk만으로 이 주소를 기본배송지로 지정 동작을 수행
	AddressDTO addressDTO = new AddressDTO();
	addressDTO.setAccountPk(accountPk);
	addressDTO.setAddressPk(addressPk);
