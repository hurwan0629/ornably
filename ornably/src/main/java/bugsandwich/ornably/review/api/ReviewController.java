...
public class ReviewController {
	...
	// 관리자 상품 관리시 상품 리뷰 조회
	@PreAuthorize("hasRole('ADMIN')")// 롤이 관리자인 관리자만 접근 가능
	@GetMapping(value = "/api/admin/item/{itemPk}/review") // 요청 url
	public ResponseEntity<?> getUserReviewDatasByItemPkAdmin(@PathVariable("reviewPk") Integer itemPk){
		List<ReviewDTO> reviewDatas = reviewService.getReviewDatasByReviewPkAdmin(itemPk); // 아이템pk에 맞는 상품 리뷰 리스트 조회
